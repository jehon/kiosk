...
const loggerFactory = (rawNamespace) => {
...
module.exports.enableDebugForRegexp = enableDebugForRegexp;
module.exports.getEnabledDebugRegexp= getEnabledDebugRegexp;
module.exports.getLoggerList = getLoggerList;
